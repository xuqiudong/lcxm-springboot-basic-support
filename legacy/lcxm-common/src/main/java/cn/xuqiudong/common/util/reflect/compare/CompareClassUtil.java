            ...
            for (Field field : fields) {
                ...
                switch (innerType) {
                    ...
                    case CASCADE_SINGLE:
                        ...
                        Object name = BeanUtils.getPropertyDescriptor(subClazz, config.innerRecordShowField()).getReadMethod().invoke(value);
                    ...
                    case CASCADE_LIST:
                        ...
                        for (Object item : listValue) {
                            Object nameValue = BeanUtils.getPropertyDescriptor(genericType, config.innerRecordShowField()) .getReadMethod().invoke(item);
