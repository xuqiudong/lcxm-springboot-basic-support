...
<#-- 导包 -->
<#list query.imports![] as imp>
import ${imp}
</#list>

/**
* ${table.comments!} 分页查询参数
*
* @author ${author}
* @since ${datetime}
*/
<#--类上的注解-->
<#list query.annotations as ann>
${ann}
</#list>
<#--是否有父类 -->
<#if query.hasSuperClass>
public class ${query.className} extends ${query.superClass} {
<#else>
public class ${query.className} {
</#if>

<#-- 遍历字段-->
<#list query.fields as field>
    /**
    *  ${field.comments}
    */
