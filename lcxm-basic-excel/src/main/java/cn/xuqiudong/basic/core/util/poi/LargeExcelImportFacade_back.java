package cn.xuqiudong.basic.core.util.poi;

import cn.xuqiudong.basic.core.util.thread.ExecutorPoolUtils;
...
/*@SuppressFBWarnings*/
public class LargeExcelImportFacade_back {

    private final static Logger logger = LoggerFactory.getLogger(LargeExcelImportFacade_back.class);

    public static Executor executor = ExecutorPoolUtils.createExecutor(200, LargeExcelImportFacade_back.class.getSimpleName());
    ...
    public static LargeExcelImportFacade_back init(InputStream sourceStream) throws Exception {
        LargeExcelImportFacade_back facade = new LargeExcelImportFacade_back();
     ...
     * @throws Exception ex
     */
    public LargeExcelImportFacade_back readSheet(int sheetIndex, int headerNumber, Consumer<Map<String, String>> callback)
            throws Exception {
    ...
    private static class LargeExcelImport {
        ...
        public static class LargeDataImportHandler implements XSSFSheetXMLHandler.SheetContentsHandler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LargeExcelImportFacade_back.init(in).readSheet(5, 2, consumer);
